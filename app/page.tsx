          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              <Image
                ...
                fill
                priority
                className="object-contain rounded-full border-4 border-brand/20 shadow-lg"
            ...
            {[
              {
                ...
                testimonial: "تجربة رائعة مع الدكتور محمد محمود، شرح مميز وطريقة سهلة في توصيل المعلومة"
              },
              {
                name: "سيف طارق",
